...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Pedro Silva";
    private static final String CONTACT_GITHUB = "https://gtihub.com/phts99";
    private static final String CONTACT_EMAIL = "phtsilva@gmail.com";
